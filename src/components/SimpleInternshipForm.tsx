...
//     try {
//       const res = await fetch("https://script.google.com/macros/s/AKfycbwyJOCxqN-DmPWX6o1FO7oiQdSwN-Ojnx5A6FuNh64rv7DFQOolTRAU8T5ElBIUL89y2w/exec", {
//         method: "POST",
//         mode: "no-cors",
//         headers: {
...
const SimpleInternshipForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch("https://script.google.com/macros/s/AKfycbz48p7-CjZsyEupcZQemLHoLr0k3mwWl0hGLbnULoY5Z0KmTIvN_urtDrQjLPa3S8ff/exec", {
      method: "POST",
      mode: "no-cors",
      headers: {
        "Content-Type": "application/json",
