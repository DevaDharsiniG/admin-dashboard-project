        ...
        >
          <div className="section-heading">
            ...
            <motion.p variants={heroChildVariant} className="section-description mt-5">
              ...
              to us. Our team is here to help you with anything related to our
              herbal products. Fill out the form below or connect with us through
              WhatsApp. We look forward to hearing from you!
            </motion.p>
          </div>
        ...
        >
          <div className="md:w-1/2 bg-gray-100 p-8 md:p-12">
            ...
            <p className="text-gray-600 mt-4 font-body">
              Feel free to contact us through email, phone, or visit our location.
            </p>

            <div className="mt-6 space-y-6 font-body">
              <ContactInfo
                icon={MapPin}
                content="9, Vijaya Nagar, Reddypalayam Road, Thanjavur-613009"
              />
              <ContactInfo
                icon={Phone}
              ...
              <ContactInfo
                icon={Mail}
                content="techvaseegrah@gmail.com"
                link="mailto:techvaseegrah@gmail.com"
              />
            </div>
            ...
            <div className="mt-8 md:mt-10">
              ...
              <div className="flex space-x-6 mt-4">
                <SocialButton
                  link="https://www.linkedin.com/company/tech-vaseegrah/posts/?feedView=all"
                  icon={<FaLinkedin size={24} />}
                />
                <SocialButton
                  link="https://www.instagram.com/techvaseegrah/"
          ...
          <form
            ref={form}
            onSubmit={sendEmail}
            className="md:w-1/2 p-8 md:p-12 space-y-5 md:space-y-6"
          >
            <div>
              <label
                htmlFor="name"
